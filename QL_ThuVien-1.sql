...
as
update PHIEUMUON
set TongMuon = (select SUM(SoLuongMuon) from CTPHIEUMUON)
...
AS
UPDATE PHONG
SET TinhTrang=N'Hết Phòng' where MaPhong=(select MaPhong from inserted)
---------------------------------------------------------------------------------------------------
...
insert into SACH
values('S01',N'Nhà Giả Kim (Tái Bản 2020)','TL01',4,N'Tài liệu giới thiệu về chuẩn mực, mục đích của chuẩn mực trong kiểm soát nội bộ, chuẩn mực thuộc tính, chuẩn mực hoạt động. Mời các bạn cùng tham khảo tài liệu để nắm chi tiết nội dung về tiêu chuẩn Kiểm toán nội bộ quốc tế','TG01',N'Mới','NXB10','KV01',100000,N'sachNhaGiaKim.jpg','NCC01'),
	('S02',N'Rừng Nauy (Tái Bản 2018)','TL01',5,N'Quy chuẩn vệ sinh an toàn thực phẩm bếp ăn LG Food trình bày nhận dạng các mối nguy mất an toàn vệ sinh thực phẩm; Các biện pháp kiểm soát mối nguy trong thực phẩm; các quy trình trong bếp ăn.','TG01',N'Mới','NXB10','KV01',120000,N'sachRungNauy.jpg','NCC01'),
	('S03',N'Start With Why','TL02',7,N'"A powerful and penetrating exploration of what separates great companies and great leaders from the rest."','TG02',N'Cũ','NXB01','KV01',140000,N'sachStarWithWhy.jpg','NCC02'),
	('S04',N'Bí Mật Tư Duy Triệu Phú (Tái Bản 2019)','TL01',3,N'Trong dáng vẻ của một câu chuyện tâm tình giữa một nhà triệu phú kỳ dị, giàu sang đến tột đỉnh với một chàng thanh niên thất bại trong sự nghiệp, đang giãy giụa vượt qua khó khăn. Bài học để trở thành triệu phú sẽ đem lại cho chúng ta một cách nhìn khác về con người mình, về những nỗi đau trần thế của mình, chỉ cho chúng ta cách sống tích...','TG02',N'Mới','NXB01','KV01',90000,N'sachTrieuPhu.jpg','NCC02'),
	('S05',N'How Money Works','TL01',2,N'A user-friendly guide to understanding key financial concepts, How Money Works takes a highly visual approach to this topic, using bold infographics with clear, jargon-free text to make finances and economics easy to understand.','TG04',N'Cũ','NXB02','KV01',780000,N'sachMoney.jpg','NCC03'),
	('S06',N'Ứng Dụng Công Nghệ Trong Kinh Doanh','TL02',6,N'Tin học ứng dụng trong kinh doanh có nội dung gồm 6 chương, trang bị cho sinh viên những kiến thức về: Một số khái niệm về hệ quản trị cơ sở dữ liệu microsoft access, bảng dữ liệu (table), truy vấn (query), biểu mẫu (form), report (biểu báo), macro (tập lệnh). Mời các bạn cùng tham khảo.','TG04',N'Mới','NXB10','KV02',110000,N'sachCongNgheKD.jpg','NCC02'),
	('S07',N'Ứng Dụng Chiến Lược Quân Sự Trong Kinh Doanh','TL02',5,N'Có một câu ngạn ngữ không ai không biết: “Thương trường là chiến trường.” Những vị tướng chỉ huy ngoài mặt trận cũng là những nhà lãnh đạo tài ba. Bởi vậy, những nguyên tắc cốt lõi của việc điều binh khiển tướng cũng có thể áp dụng vào kinh doanh...','TG03',N'Cũ','NXB03','KV02',680000,N'sachChienLuocKD.jpg','NCC04'),
	('S08',N'Giáo Trình C++ Và Lập Trình Hướng Đối Tượng','TL03',5,N'Giáo Trình C++ Và Lập Trình Hướng Đối Tượng. Lập trình cấu trúc là phương pháp tổ chức, phân chia chương trình thành các hàm, thủ tục. Chúng được dùng để xử lý dữ liệu nhưng lại tách rời các cấu trúc dữ liệu...','TG06',N'Mới','NXB04','KV02',1550000,N'sachGiaoTrinhC.jpg','NCC03'),
	('S09',N'Giáo Trình Điện Tử Thực Hành','TL03',5,N'Điện tử thực hành là môn học cơ bản trong các Khoa Điện – Điện tử của nhiều trường. Cuốn “Giáo trình Điện tử thực hành” được biên soạn dựa trên cơ sở chương trình môn học Điện tử thực hành, dùng trong các trường Cao đẳng, Đại học khối công nghệ...','TG07',N'Mới','NXB06','KV02',200000,N'sachDienTu.jpg','NCC04'),
	('S010',N'Inbound Selling - Thay Đổi Phương Thức Bán Hàng Theo Mô Hình Inbound','TL02',5,N'Ngày nay với sự phát triển của ngành digital marketing, lượng khách hàng đến từ môi trường trực tuyến có thể cao hơn rất nhiều lần bộ phận sale trực tiếp hoặc các hoạt động marketing truyền thống..','TG03',N'Cũ','NXB05','KV02',197000,N'sachSelling.jpg','NCC03'),
	('S011',N'Danh Nhân Thế Giới','TL02',5,N'Cuốn sách Danh nhân thế giới sẽ giới thiệu đến bạn đọc những nhân vật nổi tiếng thế giới. Họ là những nhà quân sự, chính trị đại tài, nhà văn hóa, những nhà bác học tên tuổi và nổi tiếng. Danh tiếng của họ mãi mãi lưu danh sử sách...','TG07',N'Mới','NXB05','KV03',210000,N'sachDanhNhan.jpg','NCC04'),
	('S012',N'Bài giảng Logic học: Bài 1 ','TL04',5,N'Bài giảng Logic học - Bài 1: Nhập môn Logic học" trình bày đại cương về logic học; logic học nhằm xây dựng hứng thú học tập logic học và vận dụng logic học vào việc học tập, rèn luyện và trong ứng xử.','TG08',N'Cũ','NXB07','KV03',99000,N'sachLogic.jpg','NCC02'),
	...
	('S014',N'Thần Tốc Luyện Đề 2021 - Môn Tiếng Anh','TL05',5,N'Không chỉ là 1 trong 3 môn thi bắt buộc mà Tiếng Anh còn là môn thi thuộc những tổ hợp xét tuyển được nhiều thí sinh lựa chọn nhất (A01, D01,..). Do đó, tỉ lệ cạnh tranh trong môn Tiếng Anh thường xuyên rất cao.','TG010',N'Mới','NXB09','KV03',70000,N'sachThiAV.jpg','NCC01'),
	('S015',N'Chất Phụ Gia Thực Phẩm - Cẩm Nang Cho Người Tiêu Dùng','TL06',5,N'Bài thuyết trình cung cấp cho người học những nội dung mà người tiêu dùng luôn muốn biết nhưng không có ai để hỏi. Hướng dẫn cho người tiêu dùng cách thức dễ dàng để biết chất phụ gia nào có trên nhãn bao bì thực phẩm, tự tìm ra tên hóa chất từ mã số của chất phụ gia đó và hiểu được vai trò, chức năng của nó.','TG07',N'Cũ','NXB08','KV03',150000,N'sachThucPham.jpg','NCC02'),
	('S016',N'Bài giảng Y Học Dinh Dưỡng - Những Điều Bác Sĩ Không Nói Với Bạn','TL04',5,N'Bài giảng Y Học Dinh Dưỡng - Những Điều Bác Sĩ Không Nói Với Bạn kiến thức dinh dưỡng trong phòng và điều trị bệnh.','TG08',N'Mới','NXB09','KV04',178000,N'sachBacSi.jpg','NCC02'),
	('S017',N'Tài liệu tập huấn kiến thức về Thực Phẩm Ngừa Ung Thư','TL07',5,N'Ăn uống thế nào để khỏe mạnh? Hiện nay, trước thực trạng thực phẩm bẩn và việc sử dụng tràn lan các phụ gia có nguồn gốc hóa chất, dẫn đến không ít người hoang mang trong việc ăn uống.','TG010',N'Cũ','NXB06','KV04',230000,N'sachNguaUThu.jpg','NCC03'),
	('S018',N'Luận văn Môn Ẩm Thực Nhật - Sushi Và Xiên Nướng','TL08',5,N'Cùng với mì Ramen, Sushi được xem là biểu tượng của đất nước mặt trời mọc và chế biến sushi gần như là một môn nghệ thuật tại Nhật Bản.  Cần ít nhất 10 năm để một người có thể trở thành nghệ nhân làm sushi nhưng bạn tin không...','TG09',N'Mới','NXB02','KV04',112000,N'sachSuShi.jpg','NCC02'),
	('S019',N'Những Tiểu Luận Triết Học','TL07',5,N'“Bertrand Russell là một nhà triết học viết văn xuôi tiếng Anh hay nhất thế kỷ XX” Anthony Howard, The Times..','TG02',N'Cũ','NXB07','KV04',139000,N'sachTrietHoc.jpg','NCC02'),
	('S020',N'Bài Giảng Cuối Cùng','TL04',5,N'Bài Giảng Cuối Cùng “Chúng ta không đổi được những quân bài đã chia, chỉ có thể đổi cách chơi những quân bài đó.” - Randy Paus','TG01',N'Mới','NXB09','KV04',184000,N'sachBaiGiang.jpg','NCC01'),
	('S021',N'Bài giảng Kiểm Soát Quản Trị - Corporate Governance','TL010',5,N'Bob Tricker được xem là “cha đẻ” của Corporate Governance / Kiểm soát quản trị. Ông đã cho ra đời cuốn sách – KIỂM SOÁT QUẢN TRỊ - được đánh giá là một trong những tác phẩm kinh điển, toàn diện và quy mô nhất về đề tài này.','TG05',N'Mới','NXB04','KV05',206000,N'sachKiemToan.jpg','NCC04'),
	('S022',N'Đề thi lý thuyết May & thiết kế thời trang năm 2011','TL05',5,N'Đề thi lý thuyết May & thiết kế thời trang năm 2011 (Mã đề TH5) sau đây gồm 5 câu hỏi với hình thức thi viết và thời gian làm bài trong vòng 180 phút. Mời các bạn cùng tham khảo và thử sức mình với đề thi nghề này nhé.','TG05',N'Mới','NXB03','KV05',106000,N'sachThoiTrang.jpg','NCC02'),
	('S023',N'Bài thuyết trình Tư Bản Thế Kỷ 21 - Le Capital Au XXIe SièCle','TL06',5,N'Bài thuyết trình Phân phối tài sản là một trong những vấn đề gây nhiều tranh cãi và được thảo luận rộng rãi nhất thời nay. Nhưng thật ra, ta biết gì về quá trình tiến hóa của phân phối tài sản trong dài hạn?','TG06',N'Mới','NXB02','KV05',153000,N'sachTuBan.jpg','NCC03'),
	('S024',N'Đồ án tốt nghiệp: Nghiên Cứu Văn Học Sử Với Hoa Bằng Qua Tạp Chí Tri Tân','TL07',5,N'Đồ án tốt nghiệp: Nghiên Cứu Văn Học Sử Với Hoa Bằng Qua Tạp Chí Tri Tân..','TG08',N'Mới','NXB03','KV05',130000,N'sachHoaBang.jpg','NCC04'),
	('S025',N'Big Data Cho Nhà Quản Lý','TL03',5,N'“Bất kỳ vị CEO nào cũng cần có khả năng đặt ra một câu hỏi liên quan đến việc kết nối dữ liệu xuyên suốt tổ chức, có khả năng điều hành hiệu quả một công ty, và đặc biệt cần có khả năng phản ứng tốt trước những sự kiện bất ngờ. Phần lớn các tổ chức đều thiếu năng lực kết nối toàn bộ dữ liệu với nhau,” theo nhận định của Tim Berners-Lee, người phát minh ra World Wide Web.','TG04',N'Mới','NXB01','KV05',180000,N'sachBigData.jpg','NCC01')
...
values('PM01','04/04/2021',1,'2001181417','TT02')

insert into PHIEUMUON
values('PM02','06/04/2021',1,'2001180221','TT02')
insert into PHIEUMUON
values('PM03','07/04/2021',2,'2001180001','TT01')
insert into PHIEUMUON
values('PM04','08/04/2021',1,'2001180002','TT03')
insert into PHIEUMUON
values('PM05','08/04/2021',2,'2001180003','TT03')
insert into PHIEUMUON
values('PM06','08/04/2021',1,'2001180001','TT01')

insert into CTPHIEUMUON
values('PM01','S01','12/04/2021',1,N'Tốt',20000)
insert into CTPHIEUMUON
values('PM01','S02','12/04/2021',3,N'Tốt',20000)
insert into CTPHIEUMUON
values ('PM01','S03','12/04/2021',3,N'Tốt',20000)
insert into CTPHIEUMUON
values ('PM01','S04','12/04/2021',3,N'Tốt',20000)
insert into CTPHIEUMUON
values ('PM02','S02','16/04/2021',3,N'Tốt',30000)
insert into CTPHIEUMUON
values ('PM03','S03','16/04/2021',1,N'Tốt',40000)
insert into CTPHIEUMUON
values ('PM04'	,'S04','16/04/2021',2,N'Tốt',40000)
insert into CTPHIEUMUON
values ('PM05'	,'S01','16/04/2021',2,N'Tốt',40000)


insert into PHIEUTRASACH(MaPT,NgayTra,SoLuongTra)
values('PT01','14/04/2021',null)
insert into PHIEUTRASACH(MaPT,NgayTra,SoLuongTra)
...
values('PT01','PM01','S01',N'tốt',4)
insert into CTPHIEUTRA(MaPT,MaPM,MaSach,TinhTrangSach,SoLuongTra)
values('PT01','PM01','S02',N'tốt',3)
insert into CTPHIEUTRA(MaPT,MaPM,MaSach,TinhTrangSach,SoLuongTra)
...
select PHIEUMUON.MaPM,SACH.MaSach,TenSach,NgayMuon
...
select PHIEUMUON.MaPM,SACH.MaSach,TenSach,CTPHIEUMUON.NgayTra
from CTPHIEUMUON,SACH,PHIEUMUON,CTPHIEUTRA,PHIEUTRASACH
where  PHIEUMUON.MaPM=  CTPHIEUMUON.MaPM and CTPHIEUMUON.MaSach = SACH.MaSach and CTPHIEUTRA.MaPT = PHIEUTRASACH.MaPT and CTPHIEUMUON.MaPM =  CTPHIEUTRA.MaPM and MSSV  = '2001181417'

select PHIEUMUON.MaPM,SACH.MaSach,TenSach,CTPHIEUMUON.NgayTra
from CTPHIEUMUON,SACH,PHIEUMUON,CTPHIEUTRA,PHIEUTRASACH
where  PHIEUMUON.MaPM=  CTPHIEUMUON.MaPM and CTPHIEUMUON.MaSach = SACH.MaSach and CTPHIEUTRA.MaPT = PHIEUTRASACH.MaPT and CTPHIEUMUON.MaPM =  CTPHIEUTRA.MaPM and MSSV  = '2001181417' and CTPHIEUMUON.NgayTra < getdate()
